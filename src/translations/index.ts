export const translations = {
    en: {
        ...
        settings: {
            ...
            help_threads: "Threads: Group logs by dragging onto each other. To extract, drop a log above its thread header.",
    ...
    ko: {
        ...
        settings: {
            ...
            help_threads: "스레드: 로그를 겹쳐서 그룹화하세요. 밖으로 꺼내려면 스레드 제목의 위쪽 공간으로 옮기면 됩니다.",
