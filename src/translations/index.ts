export const translations = {
    en: {
        ...
        settings: {
            ...
            import_note: "Note: Importing merges data. Duplicate items (by ID) are treated as new entries with mapped relationships.",
            language: "Language",
            english: "English",
            korean: "Korean",
    ...
    ko: {
        ...
        settings: {
            ...
            import_note: "참고: 가져오기는 데이터를 병합합니다. 중복된 항목(ID 기준)은 관계가 매핑된 새 항목으로 처리됩니다.",
            language: "언어",
            english: "English",
            korean: "한국어",
